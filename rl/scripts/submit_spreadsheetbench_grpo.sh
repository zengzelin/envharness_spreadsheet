...
export VAL_SIZE VAL_CONCURRENCY
...
forward = [
    ...
    "N_GPUS_PER_NODE",
    "MODE", "MODEL", "TRAIN_BS", "VAL_BS", "VAL_SIZE", "VAL_CONCURRENCY",
    "GROUP_N", "PPO_MINI_BS",
...
echo "[spreadsheet-train-submit] max_recalc_calls=${SPREADSHEETBENCH_MAX_RECALC_CALLS} recalc_timeout_s=${SPREADSHEETBENCH_RECALC_TIMEOUT_SECONDS}"
