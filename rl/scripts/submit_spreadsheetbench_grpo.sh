...
export WANDB_API_KEY="${WANDB_API_KEY:-local-5093472634860405d710cbe77b61c9f1e6a602f5}"
...
export WANDB_BASE_URL WANDB_MODE TRAINER_LOGGER PYTHONUNBUFFERED
...
forward = [
    ...
    "VAL_TEMPERATURE", "VAL_DO_SAMPLE", "KL_LOSS_COEF", "ENTROPY_COEFF",
